                ...
                <div class="card card-shadow border-0 mb-4">
                  ...
                  <div class="p-3">
                    ...
                    <ul class="list-inline font-14 mt-3">
                      ...
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - <?= $organizer["width"] ?> см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - <?= $organizer["length"] ?> см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> висота - <?= $organizer["height"] ?> см</li>
                    </ul>
