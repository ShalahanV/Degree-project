            ...
            <div class="row mt-4">
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.2575283441_ck6p.webp" alt="wrappixel kit" height="270px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Органайзер DKIOM</h5>
                    ...
                    <ul class="list-inline font-14 mt-3">
                      ...
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 12 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 15 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> висота - 4 см</li>
                    </ul>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.2430624971_nvk7.avif" alt="wrappixel kit"  height="270px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Органайзер QWSA</h5>
                    <h6 class="subtitle font-13">Матеріали: Справжня шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 15 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 15 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> висота - 5 см</li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">500 ₴</h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_organizer1.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.2575283453_c9gq.webp" alt="wrappixel kit"  height="270px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Органайзер SOFBY</h5>
                    ...
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">400 ₴</small></h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_organizer2.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="pricing5 py-5 bg-light" style="margin-top: -400px;">
          <div class="container">
            ...
            <div class="row mt-4">
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.2610118478_o91l.avif" alt="wrappixel kit" height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Органайзер DKSIN</h5>
                    <h6 class="subtitle font-13">Матеріали: Верхня зерниста шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 12 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 16 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> висота - 5 см</li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">490 ₴</h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_organizer3.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.3075601739_3mmo.avif" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Органайзер TFBA</h5>
                    <h6 class="subtitle font-13">Матеріали: Справжня шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 14 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 12 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> висота - 4 см</li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">410 ₴</h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_organizer4.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.3602243325_4sss.webp" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Органайзер BMLK</h5>
                    <h6 class="subtitle font-13">Матеріали: Верхня зерниста шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 10 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 13 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> висота - 3 см</li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">600 ₴</small></h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_organizer5.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
