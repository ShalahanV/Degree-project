    ...
    <main class="container">
      ...
      <div class="right-column">
        ...
        <div class="product-description">
          ...
          <h1>Фотобрелок IN6h</h1>
          <p>Ваші фотографії друкуються на фотопапері, який ховається в шкіряний футляр. Завдяки цьому це елегантний і щирий подарунок, який ви можете брати з собою куди завгодно. Ідеальний подарунок на будь-яке свято.</p>
        </div>
