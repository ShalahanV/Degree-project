            ...
            ?>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <br>
                  <img class="card-img-top" src="<?= $carpet["img_accessory"] ?>" alt="wrappixel kit" height="240px" width="240px">
                  <div class="p-3">
                    ...
                    <div class="d-flex mt-3 align-items-center">
                      ...
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="<?= $carpet["more_details"] ?>.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>                   
