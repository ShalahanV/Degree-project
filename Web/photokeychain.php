            ...
            <div class="row mt-4">
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.4531560457_9e24.webp" alt="wrappixel kit" height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Фотобрелок REAS23</h5>
                    ...
                    <ul class="list-inline font-14 mt-3">
                      ...
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 3 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 3 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> товщина - 1,5 см</li>
                    </ul>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.3993635943_f7ju.webp" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Фотобрелок OPD4</h5>
                    <h6 class="subtitle font-13">Матеріали: Шкіра, сталь</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 3.5 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 4.5 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> товщина - 1,5 см </li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">50 ₴</h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_photokeychain2.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.2935856336_nllm.webp" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Фотобрелок XSE0</h5>
                    <h6 class="subtitle font-13">Матеріали: Теляча шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 2 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 4 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> товщина - 0,3 см </li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">30 ₴</small></h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_photokeychain3.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="pricing5 py-5 bg-light" style="margin-top: -400px;">
          <div class="container">
            ...
            <div class="row mt-4">
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.4749455752_nbxz.webp" alt="wrappixel kit" height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Фотобрелок IN6h</h5>
                    <h6 class="subtitle font-13">Матеріали: Верхня зерниста шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 2.5 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 3 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> товщина - 0,5 см </li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">40 ₴</h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_photokeychain4.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.3704142626_i8c8.webp" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Фотобрелок uk5WAX</h5>
                    ...
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">50 ₴</h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_photokeychain5.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.4321221250_c3g7.webp" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Фотобрелок RDER54</h5>
                    <h6 class="subtitle font-13">Матеріали: Еко-шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 4 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 4 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> товщина - 1,5 см </li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">70 ₴</small></h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_photokeychain6.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
