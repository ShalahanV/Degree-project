            ...
            <div class="row mt-4">
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.4290781688_1s2t.webp" alt="wrappixel kit" height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Ремінь DVCXZ</h5>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.2535318065_pj9e.webp" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Ремінь ANTT65</h5>
                    <h6 class="subtitle font-13">Матеріали: Еко-шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 2.5 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> довжина - 70 см</li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> товщина - 0,3 см </li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">400 ₴</h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_belt2.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.4018492460_1izq.avif" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Ремінь HTYD34H</h5>
                    <h6 class="subtitle font-13">Матеріали: Натуральна шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 3 см</li><br>
                    ...
                    <div class="d-flex mt-3 align-items-center">
                      ...
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_belt3.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="pricing5 py-5 bg-light" style="margin-top: -400px;">
          <div class="container">
            ...
            <div class="row mt-4">
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.4282590064_isdo.jpg" alt="wrappixel kit" height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Ремінь DKSIN</h5>
                    ...
                    <ul class="list-inline font-14 mt-3">
                      ...
                      <li class="py-1"><i class="icon-check text-success"></i> товщина - 0,4 см </li>
                    </ul>
                    <div class="d-flex mt-3 align-items-center">
                      <h2 class="price">800 ₴</h2>
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_belt4.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.4238123556_1hg5.webp" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Ремінь QASDN01</h5>
                    ...
                    <div class="d-flex mt-3 align-items-center">
                      ...
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_belt5.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="card card-shadow border-0 mb-4">
                  <img class="card-img-top" src="Images/il_1588xN.4384727498_skri.avif" alt="wrappixel kit"  height="270px" width="358px">
                  <div class="p-3">
                    <h5 class="font-weight-medium mb-0">Ремінь SCVB</h5>
                    <h6 class="subtitle font-13">Матеріали: Повністю зерниста шкіра</h6>
                    <ul class="list-inline font-14 mt-3">
                      <li class="py-1"><i class="icon-check text-success"></i> РОЗМІРИ: </li><br>
                      <li class="py-1"><i class="icon-check text-success"></i> ширина - 2.5 см</li><br>
                    ...
                    <div class="d-flex mt-3 align-items-center">
                      ...
                      <div class="ml-auto"><a class="btn btn-danger-gradiant rounded-pill text-white btn-md border-0" href="more_details_belt6.php">Переглянути</a></div>
                    </div>
                  </div>
                </div>
              </div>
